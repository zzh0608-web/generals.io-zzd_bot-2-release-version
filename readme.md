...
If you want to push it into NA 1v1 queue, just use play(join_1v1) in console. Warning: This action will sometimes affect other's gaming experience, so you should have a carefully thinking before doing it.
...
* use keep_playing = false to let it not join the 1v1 queue again.

The last warning: Don't arbitrarily send this bot to anyone, because it will be a disaster if anyone uses it to do any bad things.
